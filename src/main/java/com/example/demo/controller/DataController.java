...
import com.example.demo.batchReport.TapzinReport;
...
//
    ...
    public List<Object> selectZoneList(){

        Map<String, String> param;
        param.put("ExternalId", "tapzin");

        List<Object> list = dao.selectZoneList(param);
